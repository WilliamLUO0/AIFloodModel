...
class MaskWeightedL1Loss(nn.Module):
    ...
    def __init__(
        ...
        if self.abs_target and not self.tau_is_physical:
            raise ValueError("[MaskWeightedL1Loss] abs_target=True requires tau_is_physical=True.")
        ...
        logger.info(
            f"[MaskWeightedL1Loss] var={self.var}, abs_target={self.abs_target}, transform={self.transform}, norm={self.norm}, "
