...
#SBATCH --job-name=eval_01_FMPFTV8_SRx8_Filter_InbaL1BCE_LW_eval_val
...
srun torchrun --nproc_per_node=1 --standalone \
  basicsr/test_flood_map.py -opt options/test/01_FMPFTV8_SRx8_Filter_InbaL1BCE_LW_eval_val.yml \
  --launcher pytorch
