#!/bin/bash
#SBATCH --job-name=fmpft_sr8_gpu4_039_FMPFTV8_SRx8_Filter_InbaL1BCE_LW
...
srun torchrun --nproc_per_node=4 --standalone \
  basicsr/train_flood_map_v2.py -opt options/train/039_FMPFTV8_SRx8_Filter_InbaL1BCE_LW.yml \
