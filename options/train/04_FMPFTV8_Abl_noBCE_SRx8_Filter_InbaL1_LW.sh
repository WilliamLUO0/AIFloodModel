#!/bin/bash
#SBATCH --job-name=fmpft_sr8_gpu4_04_FMPFTV8_Abl_noBCE_SRx8_Filter_InbaL1_LW
...
srun torchrun --nproc_per_node=4 --standalone \
  basicsr/train_flood_map_v2.py -opt options/train/04_FMPFTV8_Abl_noBCE_SRx8_Filter_InbaL1_LW.yml \
