#!/bin/bash
#SBATCH --job-name=baseline_sr8_gpu4_02_RSwinUNet_SRx8_Filter_InbaL1BCE_LW
...
srun torchrun --nproc_per_node=4 --standalone \
  basicsr/train_flood_map_v2.py -opt options/train/02_RSwinUNet_SRx8_Filter_InbaL1BCE_LW.yml \
