#!/bin/bash
#SBATCH --job-name=fmpft_sr2_gpu4_06_FMPFTV8_SRx2_Filter_InbaL1BCE_LW
...
srun torchrun --nproc_per_node=4 --standalone \
  basicsr/train_flood_map_v2.py -opt options/train/06_FMPFTV8_SRx2_Filter_InbaL1BCE_LW.yml \
