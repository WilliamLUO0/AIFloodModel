#!/bin/bash
#SBATCH --job-name=precompute_stats_h_dataset_ds8_filtered_thr0p1_min5100_full_uv
...
#python tools/precompute_split_stats.py \
#  --index_csv /nesi/nobackup/uoa04425/zluo784/Exp1/AIFloodModel/dataset_ds8_filtered_thr0p1_min5100_full/index.csv \
#  --root /nesi/nobackup/uoa04425/zluo784/Exp1/AIFloodModel/dataset_ds8_filtered_thr0p1_min5100_full \
#  --out_json /nesi/nobackup/uoa04425/zluo784/Exp1/AIFloodModel/dataset_ds8_filtered_thr0p1_min5100_full/split_stats_h_asinh_wet.json \
#  --target_var h \
#  --aux_vars zs \
#  --h_transform asinh \
#  --h_tau 0.1 \
...
#  --index_csv /nesi/nobackup/uoa04425/zluo784/Exp1/AIFloodModel/dataset_ds8_filtered_thr0p1_min5100_full/index.csv \
#  --root /nesi/nobackup/uoa04425/zluo784/Exp1/AIFloodModel/dataset_ds8_filtered_thr0p1_min5100_full \
#  --out_json /nesi/nobackup/uoa04425/zluo784/Exp1/AIFloodModel/dataset_ds8_filtered_thr0p1_min5100_full/split_stats_h_asinh.json \
#  --target_var h \
#  --aux_vars zs \
#  --h_transform asinh \
#  --h_tau 0.1 \
...
python tools/precompute_split_stats.py \
  --index_csv /nesi/nobackup/uoa04425/zluo784/Exp1/AIFloodModel/dataset_ds8_filtered_thr0p1_min5100_full/index.csv \
  --root /nesi/nobackup/uoa04425/zluo784/Exp1/AIFloodModel/dataset_ds8_filtered_thr0p1_min5100_full \
  --out_json /nesi/nobackup/uoa04425/zluo784/Exp1/AIFloodModel/dataset_ds8_filtered_thr0p1_min5100_full/split_stats_u.json \
  --target_var u \
  --reuse_split_from /nesi/nobackup/uoa04425/zluo784/Exp1/AIFloodModel/dataset_ds8_filtered_thr0p1_min5100_full/split_stats_h_asinh.json \
  --uv_tau 0.1 \
  --compute_uv_intervals \
  --uv_interval_thresholds 0.1,0.5,1.0 \
  --by scenario --val_ratio 0.2 --seed 61 \
...
python tools/precompute_split_stats.py \
  --index_csv /nesi/nobackup/uoa04425/zluo784/Exp1/AIFloodModel/dataset_ds8_filtered_thr0p1_min5100_full/index.csv \
  --root /nesi/nobackup/uoa04425/zluo784/Exp1/AIFloodModel/dataset_ds8_filtered_thr0p1_min5100_full \
  --out_json /nesi/nobackup/uoa04425/zluo784/Exp1/AIFloodModel/dataset_ds8_filtered_thr0p1_min5100_full/split_stats_v.json \
  --target_var v \
  --reuse_split_from /nesi/nobackup/uoa04425/zluo784/Exp1/AIFloodModel/dataset_ds8_filtered_thr0p1_min5100_full/split_stats_h_asinh.json \
  --uv_tau 0.1 \
  --compute_uv_intervals \
